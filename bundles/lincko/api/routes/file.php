...
$app->group('/file', function () use ($app) {
	...
	->name('file_voice'.$app->lincko->method_suffix);
	...
	$app->get(
		'/project_qrcode/:workspace/:id/:name.png',
		'\bundles\lincko\api\controllers\ControllerFile:project_qrcode_get'
	)
	->conditions(array(
		'workspace' => '\d+',
		'id' => '\d+',
